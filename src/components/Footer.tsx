            ...
            <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-3" style={{ gap: "clamp(3rem, 6vw, 4rem)" }}>
              ...
              <div className="foot-col">
                ...
                <div className="flex items-center gap-3" style={{ marginTop: "clamp(2rem, 4vw, 3rem)" }}>
                  <a href="#" className="w-9 h-9 rounded-full border border-text-08 flex items-center justify-center text-text-30 hover:text-accent hover:border-accent/30 transition-all duration-300">
