...
export default function Cta() {
  ...
  useGSAP(() => {
    ...
    // LAYER 3: Content entrance with sequential build
    ...
    // Accent image reveals with circular clip
    ...
    // LAYER 6: Magnetic button effect
    ...
    <section ref={section} className="relative bg-bg overflow-hidden">
      ...
      <div style={{ paddingTop: "clamp(10rem, 18vw, 20rem)", paddingBottom: "clamp(10rem, 18vw, 20rem)" }}>
        <div className="wrap">
          ...
          {/* LAYER 4: Bottom accent images */}
          <div className="hidden md:flex items-center justify-center cta-bottom-img" style={{ marginTop: "clamp(6rem, 12vw, 12rem)", gap: "clamp(1.5rem, 3vw, 3rem)" }}>
